...
HD_PWD='C:/Users/Magda/Desktop/Projekt_SDUP/SDUP_Project/AXI/signal_acc/signal_acc.runs/mb_design_axi_gpio_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_axi_gpio_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_axi_gpio_0_5.tcl
